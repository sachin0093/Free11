...
class MyContestPreview extends StatefulWidget {
  const MyContestPreview({super.key});

  @override
  State<MyContestPreview> createState() => _MyContestPreviewState();
}

class _MyContestPreviewState extends State<MyContestPreview>  with SingleTickerProviderStateMixin {
  int count = 2;
